...
filter_contents
	:
	| filter_contents filter_item
	;

filter_inside
	: T_STRING_FILTER_BEGIN		{ cpg_embedded_string_push (cpg_parser_context_peek_string (context),
	                                                            CPG_EMBEDDED_STRING_NODE_FILTER,
	                                                            0);}
	  filter_contents
	  T_STRING_FILTER_END		{ cpg_embedded_string_pop (cpg_parser_context_peek_string (context)); }
	;
