...
static void
memory_map_add (CpgMemoryMap     *iter,
                void             *source,
...
CpgSharedPointer
cpg_memory_map_find (CpgMemoryMap  *iter,
                     void          *source)
{
	if (!iter)
		return 0;
...
static int
copy_expression (CpgMemoryMap          *map,
                 void                  *base,
                 void                 **ptr,
                 CpgSharedExpression   *expr,
...
static int
allocate_property (CpgProperty    *property,
                   CpgMemoryMap   *map,
                   void           *base,
                   void          **ptr,
                   unsigned        maxsize)
...
static int
allocate_properties (CpgObject      *object,
                     CpgMemoryMap   *map,
                     void           *base,
                     void          **ptr,
                     unsigned        maxsize)
...
static int
copy_property (CpgProperty    *property,
               void          **propstart,
               CpgMemoryMap   *map,
               void           *base,
               void          **ptr,
...
static int
copy_properties (CpgObject      *object,
                 void          **propstart,
                 CpgMemoryMap   *map,
                 void           *base,
                 void          **ptr,
 ...
 **/
void
cpg_shared_network_copy (CpgSharedNetwork   *ret,
                         CpgNetwork         *network,
                         CpgMemoryMap       *map,
                         void               *base,
                         void              **ptr,
