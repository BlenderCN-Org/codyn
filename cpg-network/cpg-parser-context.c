                 ...
                 GSList           *attributes)
{
	...
	for (i = 0; i < cpg_attribute_num_arguments (attr); ++i)
	{
		gpointer obj = cpg_attribute_get_argument (attr, i);
                                ...
                                GSList           *attributes)
{
	...
	ret = each_selections (context, selections, attributes);
