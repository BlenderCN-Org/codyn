 ...
 * @CDN_MATH_FUNCTION_TYPE_NEQUAL: not equal
 ...
 * @CDN_MATH_FUNCTION_TYPE_LINDEX: lindex
 * @CDN_MATH_FUNCTION_TYPE_TRANSPOSE: transpose
 * @CDN_MATH_FUNCTION_TYPE_INVERSE: inverse
 * @CDN_MATH_FUNCTION_TYPE_PSEUDO_INVERSE: pseudo inverse
 * @CDN_MATH_FUNCTION_TYPE_LINSOLVE: linsolve
 * @CDN_MATH_FUNCTION_TYPE_QR: qr
 * @CDN_MATH_FUNCTION_TYPE_SLINSOLVE: slinsolve
 * @CDN_MATH_FUNCTION_TYPE_CROSS: cross
 * @CDN_MATH_FUNCTION_TYPE_SUM: sum
 * @CDN_MATH_FUNCTION_TYPE_PRODUCT: product
 * @CDN_MATH_FUNCTION_TYPE_LENGTH: length
 * @CDN_MATH_FUNCTION_TYPE_SIZE: size
 * @CDN_MATH_FUNCTION_TYPE_VCAT: vcat
 * @CDN_MATH_FUNCTION_TYPE_ZEROS: zeros
 * @CDN_MATH_FUNCTION_TYPE_EYE: eye
 * @CDN_MATH_FUNCTION_TYPE_DIAG: diag
 * @CDN_MATH_FUNCTION_TYPE_TRIL: tril
 * @CDN_MATH_FUNCTION_TYPE_TRIU: triu
 * @CDN_MATH_FUNCTION_TYPE_CSUM: csum
 * @CDN_MATH_FUNCTION_TYPE_RSUM: rsum
...
typedef enum
{
	...
	CDN_MATH_FUNCTION_TYPE_LINDEX,
	CDN_MATH_FUNCTION_TYPE_TRANSPOSE,
	CDN_MATH_FUNCTION_TYPE_INVERSE,
	CDN_MATH_FUNCTION_TYPE_PSEUDO_INVERSE,
	...
	CDN_MATH_FUNCTION_TYPE_VCAT,
	CDN_MATH_FUNCTION_TYPE_ZEROS,
	CDN_MATH_FUNCTION_TYPE_EYE,
	CDN_MATH_FUNCTION_TYPE_DIAG,
	CDN_MATH_FUNCTION_TYPE_TRIL,
	CDN_MATH_FUNCTION_TYPE_TRIU,
	CDN_MATH_FUNCTION_TYPE_CSUM,
	CDN_MATH_FUNCTION_TYPE_RSUM,
...
typedef gboolean (*CdnMathStackManipulationFunc)(CdnStackArgs const  *inargs,
                                                 CdnStackArg         *outarg,
                                                 gint                *extraspace,
                                                 GError             **error);
