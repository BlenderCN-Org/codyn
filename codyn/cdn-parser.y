...
selector_pseudo_simple_key_real
	...
	| T_KEY_SOURCED_BY			{ $$ = CDN_SELECTOR_PSEUDO_TYPE_SOURCED_BY; }
	| T_KEY_SINKED_BY			{ $$ = CDN_SELECTOR_PSEUDO_TYPE_SINKED_BY; }
	;
...
selector_pseudo_strargs_key_real
	...
	| T_KEY_PASS				{ $$ = CDN_SELECTOR_PSEUDO_TYPE_PASS; }
	;
